...
<div class="col-md-4">
  <div class="dash-card">
    <div class="dash-card-header">
      <h4>网页空间</h4>
      <span class="mdi mdi-server-minus mdi-20px" onclick="sxxx()" style="cursor:pointer;color:#95a5a6;"></span>
    </div>
    <div class="dash-card-body" id="web">
      <div class="dash-card-stat">
        <span>获取中</span>
        <span>获取中</span>
      </div>
      <div id="web-progressbar"><div class="progress-label">1%</div></div>
    </div>
  </div>
</div>
<div class="col-md-4">
  <div class="dash-card">
    <div class="dash-card-header">
      <h4>数据库空间</h4>
      <span class="mdi mdi-database mdi-20px" onclick="sxxx()" style="cursor:pointer;color:#95a5a6;"></span>
    </div>
    <div class="dash-card-body" id="sql">
      <div class="dash-card-stat">
        <span>获取中</span>
        <span>获取中</span>
      </div>
      <div id="sql-progressbar"><div class="progress-label">1%</div></div>
    </div>
  </div>
</div>
<div class="col-md-4">
  <div class="dash-card">
    <div class="dash-card-header">
      <h4>本月流量</h4>
      <span class="mdi mdi-signal mdi-20px" onclick="sxxx()" style="cursor:pointer;color:#95a5a6;"></span>
    </div>
    <div class="dash-card-body" id="lls">
      <div class="dash-card-stat">
        <span>获取中</span>
        <span>获取中</span>
      </div>
      <div id="lls-progressbar"><div class="progress-label">1%</div></div>
    </div>
  </div>
</div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="dash-card">
            <div class="dash-card-header">
                <h4>月度流量趋势</h4>
                <span id="trendIndicator" style="font-size:13px;color:#95a5a6;"></span>
            </div>
...
<div class="row" style="margin-top:4px;">
    <div class="col-lg-12">
        <div class="dash-card">
            ...
            <div class="dash-card-body">
                <div id="jqui-func-tabs">
                    <ul>
                        <li><a href="#func-config">基本配置</a></li>
                        <li><a href="#func-data">数据管理</a></li>
                        <li><a href="#func-site">网站管理</a></li>
                    </ul>
                    <div id="func-config">
                        <div class="func-grid">
                            <a href="#!" class="func-item js-create-tab" data-title="域名绑定" data-url="set.php?gn=url">
                                <i class="mdi mdi-web"></i>
                                <span>域名绑定</span>
                            </a>
                            <a href="#!" class="func-item phpvs-set">
                                <i class="mdi mdi-xml"></i>
                                <span>PHP版本</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="设置密码访问" data-url="set.php?gn=pass">
                                <i class="mdi mdi-guy-fawkes-mask"></i>
                                <span>密码访问</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="修改默认文档" data-url="set.php?gn=mrwd">
                                <i class="mdi mdi-home"></i>
                                <span>默认文档</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="设置运行目录" data-url="set.php?gn=yxml">
                                <i class="mdi mdi-television-guide"></i>
                                <span>运行目录</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="设置伪静态" data-url="set.php?gn=wjt">
                                <i class="mdi mdi-link-variant"></i>
                                <span>伪静态</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="SSL配置" data-url="set.php?gn=ssl">
                                <i class="mdi mdi-key"></i>
                                <span>SSL配置</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="防盗链配置" data-url="set.php?gn=fdl">
                                <i class="mdi mdi-access-point-network"></i>
                                <span>防盗链</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="Gzip配置" data-url="set.php?gn=gzip">
                                <i class="mdi mdi-zip-box-outline"></i>
                                <span>Gzip配置</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="缓存配置" data-url="set.php?gn=cache">
                    ...
                    <div id="func-data">
                        <div class="func-grid">
                            <a href="#!" class="func-item js-create-tab" data-title="在线文件管理" data-url="ftp.php">
                                <i class="mdi mdi-folder-open"></i>
                                <span>在线文件管理</span>
                            </a>
                            <a href="mysql.php" target="_blank" class="func-item">
                                <i class="mdi mdi-database"></i>
                                <span>数据库管理面板</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="数据库备份管理" data-url="sqlgl.php">
                                <i class="mdi mdi-database-plus"></i>
                                <span>数据库备份管理</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="数据库权限修改" data-url="set.php?gn=mysqlcz">
                    ...
                    <div id="func-site">
                        <div class="func-grid">
                            <a href="#!" class="func-item js-create-tab" data-title="一键部署" data-url="webgl.php?gn=yjbs">
                                <i class="mdi mdi-webpack"></i>
                                <span>一键部署</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="监控任务" data-url="monitor.php">
                                <i class="mdi mdi-monitor-dashboard"></i>
                                <span>监控任务</span>
                            </a>
                            <a href="#!" class="func-item js-create-tab" data-title="通知日志" data-url="notice.php">
...
<div class="col-lg-12 col-md-4">
  <div class="dash-card">
    <div class="dash-card-header">
      <h4>参数信息</h4>
      <span id="phpvsed" style="font-size:13px;color:#1abc9c;font-weight:500;">PHP版本获取中</span>
    </div>
...
<div class="col-lg-12 col-md-4 ftpxx">
  <div class="dash-card">
    <div class="dash-card-header">
      <h4>FTP信息</h4>
      <button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only js-create-tab" style="font-size:12px;padding:2px 10px;" data-title="在线文件管理" data-url="ftp.php">
        <span class="ui-button-text">在线文件管理器</span>
      </button>
    </div>
    <div class="dash-card-body" style="padding:0;">
      <table class="info-table">
        ...
        <tr><td>FTP密码：</td><td><span>**********</span> <a href="#!" onclick="xymy(this,'ftp')"><i class="mdi mdi-eye h6"></i></a> <a href="#!" onclick="copypwd('ftp')"><i class="mdi mdi-content-copy h6"></i></a></td></tr>
      </table>
    </div>
  </div>
</div>
...
<div class="col-lg-12 col-md-4 basxx">
  <div class="dash-card">
    <div class="dash-card-header">
      <h4>数据库信息</h4>
      <a href="mysql.php" target="_blank" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="font-size:12px;padding:2px 10px;">
        <span class="ui-button-text">phpMyAdmin</span>
      </a>
    </div>
    <div class="dash-card-body" style="padding:0;">
      <table class="info-table">
        ...
        <tr><td>数据库密码：</td><td><span>**********</span> <a href="#!" onclick="xymy(this,'sql')"><i class="mdi mdi-eye h6"></i></a> <a href="#!" onclick="copypwd('sql')"><i class="mdi mdi-content-copy h6"></i></a></td></tr>
      </table>
    </div>
  </div>
</div>
...
$(function() {
  ...
  $("#web-progressbar, #sql-progressbar, #lls-progressbar").progressbar({ value: 1 });
  // jQueryUI tabs
  $("#jqui-func-tabs").tabs();
});
            ...
            buttons: {
                sayMyName: {
                    ...
                    action: function() {
                        ...
                        if (!$.trim(input.val())) {
                            $.alert({ content: "PHP版本不能为空。", type: 'red' });
                            return false;
                        } else {
...
function configup(){
    ...
    $.post('./ajax.php', data, function (date) {
        ...
        if(jsoe.qk==1){
            ...
            var webStat=$("#web .dash-card-stat").children();
            var sqlStat=$("#sql .dash-card-stat").children();
            var llsStat=$("#lls .dash-card-stat").children();
            ...
            $(webStat[0]).html(Number(conf['web'].dq).toFixed(2)+'MB');
            $(webStat[1]).html(conf['web'].max+'MB');
            $("#web-progressbar").progressbar("option", "value", bfbweb);
            $("#web-progressbar .progress-label").text(bfbweb+'%');
            $(sqlStat[0]).html(Number(conf['sql'].dq).toFixed(2)+'MB');
            $(sqlStat[1]).html(conf['sql'].max+'MB');
            $("#sql-progressbar").progressbar("option", "value", bfbsql);
            $("#sql-progressbar .progress-label").text(bfbsql+'%');
            $(llsStat[0]).html(sizedwhs(conf['lls'].dq));
            $(llsStat[1]).html(conf['lls'].max+'G');
            $("#lls-progressbar").progressbar("option", "value", bfblls);
            $("#lls-progressbar .progress-label").text(bfblls+'%');
            try {
                ...
                if (trendEl && values.length >= 2) {
                    ...
                    if (prev > 0) {
                        ...
                        trendEl.innerHTML = '本月用量 <span style="color:#1abc9c;font-weight:bold">' + curr.toFixed(2) + ' GB</span>';
                    }
                }
            ...
            if(conf['qk']=='1'){var siteqk='<span class="badge badge-success"><b>运行中</b></span>'}
            else if(conf['qk']=='0'){var siteqk='<span class="badge badge-danger"><b>已暂停</b></span>'}
            else{var siteqk='<span class="badge badge-warning"><b>未知</b></span>'}
            $("#siteqk").html(siteqk);
            $("#urlnum").html(urlbds);
...
function copypwd(lx){
    if(lx=='ftp'){ var text=ftp_pass; }
    else{ var text=sql_pass; }
...
function xymy(data,lx){
    if(lx=='ftp'){ var value=ftp_pass; }
    else{ var value=sql_pass; }
